...
bool environment_interface__msg__block__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("environment_interface.msg._block.Block", full_classname_dest, 38) == 0);
  }
  environment_interface__msg__Block * ros_message = _ros_message;
  {  // name
  ...
  {  // is_support
    PyObject * field = PyObject_GetAttrString(_pymsg, "is_support");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->is_support = (Py_True == field);
    Py_DECREF(field);
  }
  {  // color
...
{
  /* NOTE(esteve): Call constructor of Block */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("environment_interface.msg._block");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Block");
  ...
  {  // is_support
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->is_support ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "is_support", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
