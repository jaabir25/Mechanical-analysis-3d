...
#include "environment_interface/msg/detail/block__rosidl_typesupport_fastrtps_c.h"
...
using _Block__ros_msg_type = environment_interface__msg__Block;
...
static uint32_t _Block__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_environment_interface__msg__Block(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = environment_interface__msg__Block;
    is_plain =
      (
...
static size_t _Block__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_environment_interface__msg__Block(
